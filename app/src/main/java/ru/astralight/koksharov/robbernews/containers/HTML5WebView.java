...
//        mContentView.addView(this);//todo why not work?
    }
    ...
    private class MyWebChromeClient extends WebChromeClient {
        ...
        public void onHideCustomView() {
            System.out.println("customview hides");
            if (mCustomView == null)
                return;
        ...
        public View getVideoLoadingProgressView() {
            ...
            if (mVideoProgressView == null) {
                ...
                mVideoProgressView = inflater.inflate(R.layout.html5_video_loading_progress, null);
            }
